...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null, $tmpFileDir = null) {
        $this->_tmpFileDir = is_dir($tmpFileDir) ? $tmpFileDir : sys_get_temp_dir();
        $this->options = array(
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $file = new stdClass();
        $fileName = md5($uploaded_file . new UDate() . Core::getUser()->getId());
        $filePath = $this->_tmpFileDir . DIRECTORY_SEPARATOR . $fileName;
        copy($uploaded_file, $filePath);
        $file->filepath = $fileName;
        $file->tmpDir = $this->_tmpFileDir;
