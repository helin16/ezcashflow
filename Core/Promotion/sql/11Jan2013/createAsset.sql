...
CREATE TABLE  `asset` (
  ...
  `assetKey` varchar(32) NOT NULL DEFAULT '',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `assetKey` (`assetKey`),
  KEY `assetTypeId` (`assetTypeId`),
  KEY `createdById` (`createdById`),
  KEY `updatedById` (`updatedById`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
insert into `asset`(`assetTypeId`, `assetKey`, `filename`, `mimeType`, `path`, `active`, `created`, `createdById`, `updated`, `updatedById`)
